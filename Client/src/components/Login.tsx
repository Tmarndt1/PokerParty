...
export default class Login extends React.Component<IProps, IState> {
    ...
    //     signalRService.unsubscribe(this.partyClosedSubscriptionId);
    //     signalRService.unsubscribe(this.connectedSubscriptionId);
    //     signalRService.unsubscribe(this.partyAddedSubscriptionId);
    // }
